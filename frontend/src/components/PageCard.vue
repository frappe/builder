<template>
	<router-link :to="{ name: 'builder', params: { pageId: page.page_name } }">
		<div
			class="rounded-2xl group relative flex w-full cursor-pointer flex-col gap-2 p-3 hover:bg-surface-elevation-1"
			:class="{
			...
			<img
				...
				class="rounded-md aspect-video w-full overflow-hidden object-cover shadow dark:border dark:border-outline-gray-1" />
