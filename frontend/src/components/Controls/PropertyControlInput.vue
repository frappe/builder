<template>
	<div class="relative w-full min-w-0">
		...
		<div
			...
			class="absolute bottom-0 left-0 right-0 top-0 flex cursor-pointer items-center gap-2 rounded-4 bg-surface-violet-2 py-0.5 pl-2.5 pr-6 text-sm text-ink-violet-8"
