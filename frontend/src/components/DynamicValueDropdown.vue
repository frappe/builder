<template>
	<div class="relative w-full min-w-0">
		...
		<div
			...
			class="pointer-events-none absolute bottom-0 left-0 right-0 top-0 flex items-center gap-2 rounded-4 bg-surface-violet-2 py-0.5 pl-2.5 pr-7 text-sm text-ink-violet-8">
