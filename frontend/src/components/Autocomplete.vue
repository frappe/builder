	...
	<div>
		<Combobox :modelValue="value" @update:modelValue="(val) => emit('update:modelValue', val)" nullable>
			<ComboboxInput
				...
				class="flex h-7 w-full items-center justify-between gap-2 rounded bg-gray-100 px-2 py-1 text-sm text-gray-800 outline-none transition-colors hover:bg-gray-200 focus:ring-2 focus:ring-gray-400 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200 dark:focus:bg-zinc-700" />
			<ComboboxOptions
